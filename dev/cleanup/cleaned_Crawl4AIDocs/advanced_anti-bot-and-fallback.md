...
## See Also
  * [Proxy & Security](https://docs.crawl4ai.com/advanced/proxy-security/) — Proxy setup, authentication, and rotation
  * [Undetected Browser](https://docs.crawl4ai.com/advanced/undetected-browser/) — Stealth mode and browser fingerprint evasion
  * [Session Management](https://docs.crawl4ai.com/advanced/session-management/) — Maintaining sessions across requests

#### On this page
  * [How Detection Works](https://docs.crawl4ai.com/advanced/anti-bot-and-fallback/#how-detection-works)
  * [Configuration Options](https://docs.crawl4ai.com/advanced/anti-bot-and-fallback/#configuration-options)
  * [Escalation Chain](https://docs.crawl4ai.com/advanced/anti-bot-and-fallback/#escalation-chain)
  * [Crawl Stats](https://docs.crawl4ai.com/advanced/anti-bot-and-fallback/#crawl-stats)
  * [Usage Examples](https://docs.crawl4ai.com/advanced/anti-bot-and-fallback/#usage-examples)
  * [Simple Retry (No Proxy)](https://docs.crawl4ai.com/advanced/anti-bot-and-fallback/#simple-retry-no-proxy)
  * [Single Proxy](https://docs.crawl4ai.com/advanced/anti-bot-and-fallback/#single-proxy)
  * [Direct-First, Then Proxies](https://docs.crawl4ai.com/advanced/anti-bot-and-fallback/#direct-first-then-proxies)
  * [Proxy List (Escalation)](https://docs.crawl4ai.com/advanced/anti-bot-and-fallback/#proxy-list-escalation)
  * [Fallback Fetch Function](https://docs.crawl4ai.com/advanced/anti-bot-and-fallback/#fallback-fetch-function)
  * [Full Escalation (All Features Combined)](https://docs.crawl4ai.com/advanced/anti-bot-and-fallback/#full-escalation-all-features-combined)
  * [Tips](https://docs.crawl4ai.com/advanced/anti-bot-and-fallback/#tips)
  * [See Also](https://docs.crawl4ai.com/advanced/anti-bot-and-fallback/#see-also)
